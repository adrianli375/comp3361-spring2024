...
def test_beam():
    ...
    print(f"Get elts: {beam.get_elts()}")
    print(f"Get elts and scores: {beam.get_elts_and_scores()}")
    print(f"Get head: {beam.head()}")
    ...
    print(f"Get elts: {beam.get_elts()}")
    print(f"Get elts and scores: {[(elt, score) for (elt, score) in beam.get_elts_and_scores()]}")
    print(f"Get head: {beam.head()}")
